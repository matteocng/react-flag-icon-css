// @flow
/**
 * This file is edited manually. The enums contained are the props of `FlagIcon` and
 * are typechecked dynamically by 'prop-types' and (optionally) statically by Flow.
...
export const flips = ['horizontal', 'vertical']
